            ...
            <accordion>
              <accordion-item>
                ...
                <template v-slot:accordion-content>
                  ...
                  Height: <span class="accordion-text">{{
                    superHero.appearance.height[0]
                  }} / {{ superHero.appearance.height[1] }}</span><br><br>
                  Race: <span class="accordion-text">{{ superHero.appearance.race }}</span><br><br>
                  Weight: <span class="accordion-text">{{
                    superHero.appearance.weight[0]
                  }} / {{ superHero.appearance.weight[1] }}</span>
                </template>
              </accordion-item>
              <accordion-item>
                <template v-slot:accordion-trigger>
                ...
                <template v-slot:accordion-content>
                  Aliases: <span class="accordion-text" v-for="alias in superHero.biography.aliases"
                                 :key="alias">{{ alias }}, </span><br><br>
              ...
              <accordion-item>
                ...
                <template v-slot:accordion-content>
                  Group Affiliation: <span class="accordion-text">{{
